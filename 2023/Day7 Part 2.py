...
# half of the horizon. The Elf explains that the rocks are all along the part of Desert Island that is directly #
# above Island Island, making it hard to even get there. Normally, they use big machines to move the rocks and  #
# filter the sand, but the machines have broken down because Desert Island recently stopped receiving the parts #
...
# each hand. If these cards are different, the hand with the stronger first card is considered stronger. If the #
# first card in each hand have the same label, however, then move on to considering the second card in each     #
# hand. If they differ, the hand with the higher second card wins; otherwise, continue with the third card in   #
...
# bid multiplied by its rank, where the weakest hand gets rank 1, the second-weakest hand gets rank 2, and so   #
# on up to the strongest hand. Because there are five hands in this example, the strongest hand will have rank  #
# 5 and its bid will be multiplied by 5.                                                                        #
#                                                                                                               #
...
# is now considered four of a kind. However, for the purpose of breaking ties between two hands of the same     #
# type, J is always treated as J, not the card it's pretending to be: JKKK2 is weaker than QQQQ2 because J is   #
# weaker than Q.                                                                                                #
#                                                                                                               #
