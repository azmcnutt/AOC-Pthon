...
# yet another mountain - the largest mountain on Lava Island. As you approach the mountain, you find that the   #
# light is being collected by the wall of a large facility embedded in the mountainside.                        #
#                                                                                                               #
...
# loose-fitting hard hat. The reindeer leads you to a shelf of goggles and hard hats (you quickly find some     #
# that fit) and then further into the facility. At one point, you pass a button with a faint snout mark and the #
...
# that collects all of the light from outside. As you admire the large assortment of lenses available to        #
# further focus the light, the reindeer brings you a book titled "Initialization Manual".                       #
#                                                                                                               #
# "Hello!", the book cheerfully begins, apparently unaware of the concerned reindeer reading over your          #
# shoulder. "This procedure will let you bring the Lava Production Facility online - all without burning or     #
# melting anything unintended!"                                                                                 #
#                                                                                                               #
# "Before you begin, please be prepared to use the Holiday ASCII String Helper algorithm (appendix 1A)." You    #
# turn to appendix 1A. The reindeer leans closer with interest.                                                 #
#                                                                                                               #
# The HASH algorithm is a way to turn any string of characters into a single number in the range 0 to 255. To   #
# run the HASH algorithm on a string, start with a current value of 0. Then, for each character in the string   #
...
# Production Facility. Ignore newline characters when parsing the initialization sequence. To verify that your  #
# HASH algorithm is working, the book offers the sum of the result of running the HASH algorithm on each step   #
...
# starting from the point where light enters the facility. The boxes have holes that allow light to pass from   #
...
# passing through the box. The side of each box has a panel that opens to allow you to insert or remove lenses  #
# as necessary.                                                                                                 #
#                                                                                                               #
