...
# Part 1                                                                                                        #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# You reach the place where all of the mirrors were pointing: a massive parabolic reflector dish attached to    #
...
# and pulleys to a large metal platform below the dish. The platform is covered in large rocks of various       #
# shapes. Depending on their position, the weight of the rocks deforms the platform, and the shape of the       #
...
# south edge of the platform, including the row the rock is on. (Cube-shaped rocks (#) don't contribute to      #
# load.) So, the amount of load caused by each rock in each row is as follows:                                  #
#                                                                                                               #
# OOOO.#.O.. 10                                                                                                 #
# OO..#....#  9                                                                                                 #
# OO..O##..O  8                                                                                                 #
...
# the rocks to the edges of the platform. Fortunately, a button on the side of the control panel labeled "spin  #
...
# direction. After one cycle, the platform will have finished rolling the rounded rocks in those four           #
...
# support beams. To make sure they'll survive for a while, you need to calculate the total load on the north    #
